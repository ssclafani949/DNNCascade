def _dumpScenario():
    ...
    scenario.clear()
    try:
        artist = scenario.add( 'Bubbles', ['I3Geometry', 'SplitInIceDSTPulses', ] )
        scenario.setIsActive( artist, False )
        scenario.changeSetting( artist, 'scale', 10 )
        scenario.changeSetting( artist, 'colormap', ColorMap.getPythonMapByName('PuBu') )
    ...
    try:
        ...
        scenario.changeSetting( artist, 'colormap', ColorMap.getPythonMapByName('Blues') )
        scenario.changeSetting( artist, 'power', 0.15 )
        scenario.changeSetting( artist, 'color', PyQColor(87,87,87,153) )
    ...
    try:
        ...
        scenario.setIsActive( artist, False )
        scenario.changeSetting( artist, 'color', PyQColor(255,0,255,255) )
    ...
    window.gl.setCameraLoc(655.971618652, 1581.89746094, 62.0706710815)
    window.gl.setCameraOrientation(-0.922073423862, 0.387013703585, -7.18235969543e-06)
